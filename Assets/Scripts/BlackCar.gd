...
func _physics_process(delta):	
	...
	camera_pivot.global_position = camera_pivot.global_position.lerp(global_position, delta * 10.0)
	...
	if(Input.is_action_pressed("slide")):
		slidepower = 3000
		#RFW.wheel_friction_slip = 1.0
		RBW.wheel_friction_slip = 0.3
		#LFW.wheel_friction_slip = 1.0
		LBW.wheel_friction_slip = 0.3		
